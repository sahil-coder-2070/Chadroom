  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center flex-col gap-12 mt-6">
        <h1 className="text-center uppercase text-[120px] font-extrabold leading-28 ">
          Run on <br /> autopilot
        </h1>
        ...
        <div className="flex items-center flex-col gap-3 w-150 relative">
          <p className="text-md text-neutral-500">
            Describe your business, get powerful software
          </p>
          <textarea
            className="h-30 w-150 border border-neutral-200 
              focus:border-blue-700 focus:outline-none active:outline-none p-3 rounded-md bg-white resize-none "
          ></textarea>
          <button className=" absolute py-2 px-4 bg-neutral-100/80 border border-neutral-200 text-sm rounded-md  bottom-2 right-2">
            Generate
          </button>
        </div>
      </div>
