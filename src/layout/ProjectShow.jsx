    ...
    <div className="flex justify-center items-center w-full md:max-w-6xl m-auto min-h-screen p-3 md:p-0 overflow-hidden">
      <div className="border border-gray-200 min-h-150 w-full bg-white rounded-xl overflow-hidden shadow-[0_20px_10px_-20px_rgba(0,0,0,0.3)] flex md:flex-row flex-col ">
        <div className=" md:w-1/4 border-r border-neutral-200 ">
          ...
          <div className="hidden  py-4 px-5 md:flex flex-col gap-2 border-b border-neutral-200 ">
          ...
          <div className="py-4 px-5 flex flex-col md:flex-col gap-3">
            <div className="flex flex-row   items-center justify-between">
              <h2 className="font-bold text-sm text-neutral-500">APPS</h2>
              <CirclePlus size={16} color="#a3a3a3" />
            </div>
            <div className="flex border-t border-neutral-200 pt-3 md:pt-0 md:border-none md:flex-col  gap-3">
                ...
                return (
                  <div key={index} className=" flex ">
                    <div className="flex  items-center gap-2">
                      ...
                      <p className="text-[13px] md:text-sm text-neutral-800 font-medium ">
                        {item.title}
                      </p>
                    </div>
                  </div>
